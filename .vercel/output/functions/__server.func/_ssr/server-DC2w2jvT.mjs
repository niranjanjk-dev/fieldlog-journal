...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CQF__ZSW.mjs");
...
var manifest = { "33d28cf81a684e99f43f74ae939b7eccf8810610ac9db7142c41cf93d9c6f3d4": {
	functionName: "reverseGeocode_createServerFn_handler",
	importer: () => import("./geocode.functions-B1UhI5rY.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D-Yy82-a.mjs").then((n) => n.x).then((n) => n.t),
		import("./start-BBN1avIv.mjs"),

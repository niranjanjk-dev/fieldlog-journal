...
import { A as initials, P as meQuery, S as Button, a as BentoCard, i as AvatarImage, n as Avatar, o as BentoGrid, r as AvatarFallback, t as AppShell, w as cn } from "./router-Bxv_pBoA.mjs";
import { E as MessageSquare, M as LoaderCircle, a as User, g as Send, xt as ArrowLeft } from "../_libs/lucide-react.mjs";
import { t as Input } from "./input-Dg9UVl2Y.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/inbox-C4PnJ0Ix.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BentoGrid, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BentoCard, {
					className: cn("lg:col-span-2 p-0 flex flex-col h-full overflow-hidden", activeContactId ? "hidden lg:flex" : "flex"),
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: cn("lg:col-span-4 p-0 flex flex-col h-full overflow-hidden", !activeContactId ? "hidden lg:flex" : "flex"),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									variant: "ghost",
									size: "icon",
									className: "lg:hidden shrink-0 -ml-2 press rounded-full",

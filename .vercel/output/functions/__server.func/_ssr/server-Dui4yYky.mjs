...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-4IHE5_QI.mjs");
...
var manifest = { "33d28cf81a684e99f43f74ae939b7eccf8810610ac9db7142c41cf93d9c6f3d4": {
	...
	importer: () => import("./geocode.functions-oBz5yTi-.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Bxv_pBoA.mjs").then((n) => n.x).then((n) => n.t),
